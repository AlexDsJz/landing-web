...
const ContactDetailsView = ({ contact, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${contact.id}/edit`} class="btn btn-secondary mr-2">Edit contact</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete contact</button>
      </div>
    </div>
  </div>;
